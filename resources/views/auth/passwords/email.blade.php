...
<div class="rui-sign align-items-center justify-content-center">
    ...
    {{ Form::open(["route" => "password.email", "class" => "form rui-sign-form rui-sign-form-cloud"]) }}
        <div class="row vertical-gap sm-gap justify-content-center">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-brand btn-block text-center">Send Password Reset Link</button>
            </div>
        </div>
    {{ Form::close() }}
